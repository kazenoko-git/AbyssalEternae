...
class RPGGame(Application):
    ...
    def initialize_game(self):
        ...
        player.add_component(MeshRenderer(mesh=player_mesh))
    ...
    def _load_starting_town(self):
        ...
        ground_transform.local_scale = np.array([50.0, 1.0, 50.0], dtype=np.float32) # Scale plane
        
        ground_mesh = create_plane_mesh(1.0, 1.0)
        ground.add_component(MeshRenderer(mesh=ground_mesh))
    ...
    def _spawn_npc(self, npc_id: str, name: str, position: np.ndarray):
        ...
        npc.add_component(MeshRenderer(mesh=npc_mesh))
